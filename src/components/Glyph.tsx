...
export function Glyph({ id }: { id: AppId }) {
  ...
  if (id === 'gallery' || id === 'imageViewer') return <svg {...common}><rect x="8" y="9" width="32" height="30" rx="7" /><circle cx="18" cy="19" r="3" /><path d="m11 35 9-9 6 6 4-4 7 7" /></svg>
  ...
  if (id === 'themes' || id === 'paint') return <svg {...common}><circle cx="24" cy="24" r="15" /><circle cx="18" cy="18" r="2" fill="currentColor" stroke="none" /><circle cx="28" cy="16" r="2" fill="currentColor" stroke="none" /><circle cx="32" cy="25" r="2" fill="currentColor" stroke="none" /><path d="M25 39c-3-2-4-5-2-8 2-3 6-2 9-1 4 1 7-2 7-6" /></svg>
  if (id === 'terminal') return <svg {...common}><rect x="7" y="9" width="34" height="30" rx="7" /><path d="m14 18 6 6-6 6M25 31h9" /></svg>
  if (id === 'recycle') return <svg {...common}><path d="M13 15h22l-2 25H15z" /><path d="M10 15h28M19 15V10h10v5M20 21v13M28 21v13" /></svg>
  if (id === 'calculator') return <svg {...common}><rect x="10" y="6" width="28" height="36" rx="5" /><rect x="15" y="11" width="18" height="7" rx="1" /><path d="M16 25h2M24 25h2M32 25h0M16 32h2M24 32h2M32 32h0" /></svg>
  if (id === 'media') return <svg {...common}><circle cx="24" cy="24" r="17" /><path d="m20 16 13 8-13 8z" /></svg>
